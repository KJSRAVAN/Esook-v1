...
void main() {
  testWidgets('EsouqApp bootstrap renders session bootstrap and transitions to login when unauthenticated', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(EsouqApp(
      config: config,
