...
void main() {
  ...
  group('RiderOrderStatus', () {
    ...
    test('fromString parses completed and DELIVERED', () {
      expect(RiderOrderStatus.fromString('completed'),
    ...
    test('toBackendString returns correct strings', () {
      expect(RiderOrderStatus.ready.toBackendString(), 'preparing');
      expect(
          RiderOrderStatus.outForDelivery.toBackendString(), 'out_for_delivery');
      expect(RiderOrderStatus.delivered.toBackendString(), 'completed');
    });
  ...
  group('RiderOrderModel', () {
    ...
    test('fromJson parses actual production backend /api/orders flat fields', () {
      final backendJson = {
        'id': 'ord-prod-100',
