...
void main() {
  group('OrderRepositoryImpl', () {
    ...
    test('createOrder sends POST /orders with correct body and X-Idempotency-Key header', () async {
      ...
      final result = await orderRepository.createOrder(
        ...
        notes: 'Doorbell broken',
        items: const [
          OrderItemInput(itemId: 'prod-1', quantity: 4),
        ],
    ...
    test('getOrderById returns single order details from GET /orders/:id', () async {
      mockTransport.statusCode = 200;
      mockTransport.responseBody = jsonEncode({
        'order': {
          'id': 'ord-555',
