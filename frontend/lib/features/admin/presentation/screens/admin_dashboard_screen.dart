...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    if (usersResult.isSuccess && storesResult.isSuccess) {
      ...
      final error =
          usersResult.failureOrNull?.message ??
  ...
  Widget _buildBody() {
    ...
    final driverCount = _users
        .where(
          (u) => u.role.isDeliveryRider || u.rawRole?.toUpperCase() == 'DRIVER',
        )
        .length;
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  subtitle: const Text(
                    'Onboard new supermarket locations, update addresses and status',
                  ),
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'View customer accounts, staff rosters, and role assignments',
                  ),
                  trailing: const Icon(Icons.chevron_right_rounded),
                  onTap: () => widget.onNavigateTab?.call(2),
                ),
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Register new delivery partners and manage fleet credentials',
                  ),
                  trailing: const Icon(Icons.chevron_right_rounded),
                  onTap: () => widget.onNavigateTab?.call(3),
                ),
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    'Monitor store fulfillment and active deliveries',
                  ),
                  trailing: const Icon(Icons.chevron_right_rounded),
